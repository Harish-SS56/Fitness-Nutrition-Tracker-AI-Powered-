...
import { Search, Plus, Edit, Trash2, Database, Sparkles, AlertCircle, ArrowLeft, Home } from "lucide-react"
...
export default function NutritionDatabase() {
  ...
  useEffect(() => {
    ...
    if (searchQuery.trim()) {
      ...
      setFilteredData(nutritionData.slice(0, 100)) // Show first 100 items when no search
    }
  ...
  const loadNutritionData = async () => {
    ...
    try {
      ...
      if (data.success) {
        ...
        setFilteredData(data.nutrition.slice(0, 100))
      }
    } catch (error) {
        ...
        <div className="mb-8 flex justify-between items-start">
          <div>
            ...
            <p className="text-muted-foreground">
              Comprehensive food nutrition database with AI-powered calculations for unknown foods
            </p>
          </div>
        </div>
        ...
        <div className="space-y-6">
          <Card className="bg-card border-border">
            <CardHeader>
              ...
              <CardDescription>
                Search, view, and manage nutrition information. AI automatically calculates nutrition for unknown foods.
              </CardDescription>
            </CardHeader>
              ...
              <div className="grid md:grid-cols-3 gap-4">
                <Card className="bg-muted/50">
                  <CardContent className="p-4 text-center">
                    <div className="text-2xl font-bold text-primary">{nutritionData.length}</div>
                    <div className="text-sm text-muted-foreground">Total Foods</div>
                  </CardContent>
                </Card>
                <Card className="bg-muted/50">
                  <CardContent className="p-4 text-center">
                    <div className="text-2xl font-bold text-secondary">{filteredData.length}</div>
                    <div className="text-sm text-muted-foreground">Search Results</div>
                  </CardContent>
                </Card>
                <Card className="bg-muted/50">
                  <CardContent className="p-4 text-center">
                    <div className="text-2xl font-bold text-accent">AI + DB</div>
                    <div className="text-sm text-muted-foreground">Hybrid System</div>
                  </CardContent>
                </Card>
              </div>
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <Card className="bg-muted/50">
              <CardContent className="p-4">
                ...
                <p className="text-sm text-muted-foreground">
                  Foods from your comprehensive nutrition database with verified values from reliable sources
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-muted/50">
              <CardContent className="p-4">
                ...
                <p className="text-sm text-muted-foreground">
                  Foods calculated by Gemini AI when not found in database - accurate estimates based on food composition data
                </p>
              </CardContent>
            </Card>
          </div>
